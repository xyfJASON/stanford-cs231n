    ...
    def loss(self, X, y=None):
        ...
        for l in range(1, self.num_layers + 1):
            ...
            if l == self.num_layers:
                scores, caches[l] = affine_forward(scores, W, b)
            else:
                if self.normalization == None:
                    scores, caches[l] = affine_relu_forward(scores, W, b)
        ...
        for l in range(self.num_layers, 0, -1):
            if l == self.num_layers:
                dscores, grads['W'+str(l)], grads['b'+str(l)] = affine_backward(dscores, caches[l])
            else:
                if self.use_dropout:
                    dscores = dropout_backward(dscores, caches[l][1])
                if self.normalization == None:
